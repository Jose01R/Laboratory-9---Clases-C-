...
${OBJECTDIR}/mutex1.o: mutex1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mutex1.o mutex1.cpp
...
${OBJECTDIR}/mutex4.o: mutex4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mutex4.o mutex4.cpp
...
${OBJECTDIR}/semaphore4.o: semaphore4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/semaphore4.o semaphore4.cpp

${OBJECTDIR}/semaphore5.o: semaphore5.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/semaphore5.o semaphore5.cpp
